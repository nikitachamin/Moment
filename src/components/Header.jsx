    ...
    <header className="header">
      <nav className="blue-grey darken-3">
        <div className="nav-wrapper blue-grey darken-3">
          ...
          <span className={`menu-icon ${isMenuOpen ? "opened" : ""}`}>
            <img
      ...
      <div className="header_info-wrapper blue-grey lighten-5">
        {isMenuOpen && (
          <MenuTop
            className={`menu-top ${isMenuOpen ? "open" : ""}`}
        ...
        <div className="logo_info">
          ...
          <p>
            Памятники из природного камня <br />
            от 27 900 рублей
          </p>
          <p>Беспроцентная рассрочка через Тинькофф Банк</p>
        </div>

        <div className="header_info-place">
          <div className="adress">
            <h4 className="logo_info_title">
              Бесплатная консультация и расчёт стоимости
            </h4>
            <p>График работы с 9:00 до 22:00</p>
            <div className="popup-container">
              <p className="pulse-text" onClick={toggleHideTextOpen}>
                <span className="material-symbols-outlined main-icon">
                  east
                </span>
                Получите уставноку бесплатно!
              </p>
              <a href="tel:+74952265171" className="btn btn-success">
                +7 495 226 51 71
              </a>
              {isOpen && (
                <div className="popup">
                  <p>
                    Позвоните для получения бесплатной консультацию, и мы не
                    только предложим вам профессиональное решение, но и{" "}
                    <strong>установим памятник абсолютно бесплатно!</strong> Не
                    упустите шанс воспользоваться нашим уникальным предложением
                    — позвоните прямо сейчас и узнайте, как мы можем помочь вам!
                  </p>
                </div>
              )}
            </div>
